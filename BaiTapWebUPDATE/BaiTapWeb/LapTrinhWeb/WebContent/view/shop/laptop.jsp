...
<body>
	...
	<div id="s-title">
		<p>
			<a href="/LapTrinhWeb/home-shop">HOME</a>/LAPTOP
		</p>
		<h1>Laptop</h1>
		<p>
			<a href="/LapTrinhWeb/laptop">&larr; Back to Home</a>
		</p>
	</div>
    ...
    $('.product-swapper div').removeClass('product-box-after');
        ...
        $('#checkLaptop').css("list-style-image", "url(/LapTrinhWeb/static/images/checkboxCheck.png)");
