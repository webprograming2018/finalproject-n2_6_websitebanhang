...
public class SmartphoneControl extends HttpServlet {
	ProductService productService = new ProductServiceImpl();

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		List<Product> list = productService.getByDanhMuc(1);
		Gson gson = new Gson();
		req.setAttribute("list", gson.toJson(list));
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/view/shop/smartphone.jsp");
