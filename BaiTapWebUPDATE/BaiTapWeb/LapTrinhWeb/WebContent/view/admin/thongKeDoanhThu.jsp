...
<head>
    ...
    <script type='text/javascript'>
      ...
      function drawChart() {
        ...
        data.addRows([
          [new Date(2017, 12, 1), 0],
          [new Date(2018, 1, 1), t1],
          [new Date(2018, 2, 1), t2],
          [new Date(2018, 3, 1), t3],
          [new Date(2018, 4, 1), t4],
          [new Date(2018, 5, 1), t5],
          [new Date(2018, 6, 1), t6],
          [new Date(2018, 7, 1), t7],
          [new Date(2018, 8, 1), t8],
          [new Date(2018, 9, 1), t9],
          [new Date(2018, 10, 1), t1],
          [new Date(2018, 11, 1), t11],
          [new Date(2018, 12, 1), t12]
        ]);
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Biểu đồ <small>Thống kê doanh thu theo tháng trong năm 2018</small></h3>
