                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="title_right">
				             <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
				             	<c:url value="/admin/member/tim-kiem" var="url"></c:url>
				                <form action="${url}" method="post">
				                <div class="input-group">
				                    <input type="text" name="timkiem" class="form-control" placeholder="Search for...">
                        ...
                        <div class="x_content">             
                          ...
                          <tbody>
                             ...
                             <c:if test="${listMember==null}">
                           		<tr class="odd gradeX" align="center">
                           			<td colspan="10">Không có thành viên nào.</td>
                           		</tr>
                           </c:if>
                          </tbody>
                      </table>
